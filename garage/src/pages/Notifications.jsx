                ...
                <div className="overflow-y-auto h-[860px]">
                    {loading ? (
                        ...
                        <div className="divide-y divide-[#e6f0fa]">
                            <div className="p-4 bg-white/40 border-b border-[#e6f0fa] flex justify-end">
                                <button
                                    onClick={markAllRead}
                                    className="flex items-center gap-2 px-4 py-2 bg-white border border-blue-100 rounded-lg text-sm font-bold text-blue-600 hover:bg-blue-50 transition-colors shadow-sm"
                                >
