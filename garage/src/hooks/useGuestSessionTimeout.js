...
import { broadcastGarageLogout } from './useMultiTabAuthSync';
    ...
    useEffect(() => {
        ...
        const terminateSession = (reason) => {
            ...
            const alertMsg = reason === 'inactivity'
                ? 'Guest garage session timed out due to 15 minutes of inactivity.'
                : 'Guest garage session timed out (15-minute maximum limit reached).';
