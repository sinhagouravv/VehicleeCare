...
const EMPLOYEE_PAGES = [
    ...
    { name: 'Average Duration', path: '/average-duration' },
    { name: 'Success Rate', path: '/success-rate' },
                    ...
                    {isOpen && searchTerm.trim() && (
                        <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-blue-100 rounded-xl shadow-[0_10px_40px_-10px_rgba(5,37,88,0.15)] overflow-hidden py-2 z-50 max-h-[25rem] overflow-y-auto">
                            ...
                            {filteredPages.length > 0 && (
                                <div className="mb-2">
                                    <h4 className="px-4 py-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-gray-50/50">Employee Pages</h4>
