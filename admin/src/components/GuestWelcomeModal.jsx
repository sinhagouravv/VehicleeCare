...
const policyData = {
    terms: {
        ...
        subtitle: "Guest Admin Access",
        icon: <FileText className="text-[#527FB0]" size={22} />,
        paragraphs: [
            "VehicleeCare provides Guest Admin access solely to allow authorized users to explore and experience the functionality and features of the Admin Dashboard.",
            "Guest Admin accounts are provided with read-only access. You may view authorized dashboard information, but you may not modify, delete, manipulate, download, reproduce, distribute, or misuse any data displayed within the dashboard.",
            ...
            "VehicleeCare reserves the right to modify, suspend, or terminate Guest Admin access at any time if misuse, unauthorized activity, or a violation of these terms is detected.",
    ...
    privacy: {
        ...
        paragraphs: [
            "VehicleeCare respects your privacy and is committed to protecting information accessed through the Admin Dashboard. We take reasonable technical and organizational measures to maintain the confidentiality and security of information available through the platform.",
            ...
            "Guest Admin access is limited to authorized information, and sensitive, confidential, or personally identifiable information may be restricted or excluded based on your access level.",
            ...
            "By continuing to use the Guest Admin Dashboard, you acknowledge and understand that the information described above may be collected and processed for the purposes stated in this Privacy Policy."
        ]
    },
    security: {
        ...
        paragraphs: [
            "Guest Admin access is provided for authorized and controlled use only. Users are expected to use the dashboard responsibly and comply with all applicable policies, security requirements, and access restrictions.",
            ...
            "For security purposes, your activity on this Guest Admin page may be monitored and recorded. This may include your IP address, device and browser information, access time, and relevant activity logs. This information is collected for security, auditing, troubleshooting, and abuse-prevention purposes related to the Guest Admin experience.",
            ...
            "By selecting “Get Started” and continuing to use the Guest Admin Dashboard, you acknowledge and consent to the monitoring and collection of technical information described above as part of the Guest Admin experience."
        ]
    }
};
    ...
    useEffect(() => {
        if (showWelcomeSplash) {
            const timer = setTimeout(() => {
                ...
                setShowWelcomeSplash(false);
                setTimeout(() => {
                    triggerAlert('Your Guest Admin session will expire in 15 minutes', 'success');
                }, 400);
            }, 5000);
        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                            ...
                            <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
                                ...
                                <motion.div 
                                    ...
                                    className={`w-full ${
                                        ...
                                        activePolicyModal === 'terms' ? 'bg-white/100' : 'bg-white/100'
                                    } border border-white/70 rounded-3xl relative z-10 px-6 py-4 flex flex-col max-h-[85vh] text-center shadow-sm`}
                                >
                    ...
                    {/* Animated Welcome Screen Overlay with smooth transition to Admin page */}
                    {showWelcomeSplash && (
