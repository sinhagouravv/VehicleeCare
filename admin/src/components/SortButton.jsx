    ...
    return (
        <>
            ...
            <button
                ...
                className={`fixed bottom-[25.65rem] right-9 z-50 p-3 rounded-full border flex items-center justify-center transition-all duration-300 ease-out shadow-sm hover:shadow-md cursor-pointer group ${
                    isMenuOpen
            ...
            >
                <ArrowUpDown size={24} className="transition-transform duration-300" />
                {hasActiveSort && (
            ...
            {isSortOpen && (
                <div
                    ref={popupRef}
                    className="fixed bottom-[25.65rem] right-24 z-50 w-max max-w-[calc(100vw-7.5rem)] bg-white/95 backdrop-blur-2xl border border-blue-100/80 rounded-3xl shadow-[0_12px_40px_rgba(0,0,0,0.12)] overflow-hidden p-5 space-y-4 animate-in fade-in zoom-in-95 duration-200"
                >
                    {/* Header */}
