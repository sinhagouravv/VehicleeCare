                                    ...
                                    >
                                        ...
                                        <td className="p-4.5 text-center">
                                            <div className="flex flex-col uppercase items-center justify-center">
                                                ...
                                                <span className={`text-xs lowercase text-gray-500 text-center ${isGuest && isRealValue(message.email) ? 'blur-sm select-none pointer-events-none' : ''}`}>{maskEmail(message.email)}</span>
                                            </div>
                                        </td>
                            ...
                            <div className="flex flex-col md:flex-row gap-6 w-full">
                                <div className="space-y-4 w-full md:w-[60%]">
                                    ...
                                    <div className="pt-4 rounded-xl space-y-2 uppercase">
                                        ...
                                        <p className="text-sm flex"><span className="text-gray-500 w-24 shrink-0">Phone:</span> <span className={`font-semibold text-gray-800 truncate ${isGuest && isRealValue(selectedMessage.phone) ? 'blur-sm select-none pointer-events-none' : ''}`}>{maskPhone(selectedMessage.phone)}</span></p>
                                        <p className="text-sm flex"><span className="text-gray-500 w-24 shrink-0">Email:</span> <span className={`font-semibold text-gray-800 truncate ${isGuest && isRealValue(selectedMessage.email) ? 'blur-sm select-none pointer-events-none' : ''}`}>{maskEmail(selectedMessage.email)}</span></p>
                                    </div>
                                </div>
