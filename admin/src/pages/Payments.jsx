                    ...
                    <table className="w-full text-center border-collapse table-fixed">
                        ...
                        <tbody className="divide-y uppercase text-[12px] divide-[#e6f0fa]">
                            {loading ? (
                                ...
                                return (
                                    <tr key={payment._id} id={`row-${rowId}`} className={`text-center mt-7 fixed transition-all duration-1000 ${highlightedRow === rowId ? 'bg-emerald-100/60 rounded-2xl relative z-20 scale-[1.01]' : 'hover:bg-blue-50/30'}`}>
